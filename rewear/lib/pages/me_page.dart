...
class _MePageState extends State<MePage> with SingleTickerProviderStateMixin {
  ...
  Future<void> _changeAvatar() async {
    ...
    final xfile =
        await picker.pickImage(source: source, imageQuality: 80, maxWidth: 600);
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              Row(children: [
                                _profileStat(
                                    '${_myProducts.length}', 'Listings'),
                                _vDivider(),
                                _profileStat(
                                    '${_soldProducts.length}', 'Sold'),
                                _vDivider(),
                                _profileStat(
                                    '$_buyCount', 'Purchased'),
                              ]),
                        ...
                        Container(
                          ...
                          child: TabBar(
                            ...
                            tabs: [
                              Tab(
                                  text:
                                      'Listings (${_myProducts.length})'),
                              Tab(
                                  text:
                                      'Purchases (${_myPurchases.length})'),
                              Tab(
                                  text:
                                      'Sales (${_mySales.length})'),
                            ],
                          ),
                        ),
                      ],
...
class _ListingsTab extends StatefulWidget {
  ...
  const _ListingsTab(
      {required this.activeProducts, required this.soldProducts});
  @override
...
class _ListingsTabState extends State<_ListingsTab> {
  ...
  Widget build(BuildContext context) {
    final products =
        _showActive ? widget.activeProducts : widget.soldProducts;
            ...
            : GridView.builder(
                ...
                itemBuilder: (context, i) {
                  ...
                  return GestureDetector(
                    ...
                    child: _ProductCard(
                        product: p, showSoldBadge: !_showActive),
                  );
                },
              ),
      ),
      ...
      return Center(
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          GestureDetector(
            ...
            child: const Text('View full purchase history →',
                style: TextStyle(
                    fontSize: 12,
      ...
      return Center(
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          GestureDetector(
            ...
            child: const Text('View full sales history →',
                style: TextStyle(
                    fontSize: 12,
                    color: Color(0xFF2563EB),
                    fontWeight: FontWeight.w600)),
      ...
      itemBuilder: (context, i) {
        ...
        if (i == 0) {
          final completedCount =
              sales.where((s) => s['status'] == 'Completed').length;
          return Container(
            padding: const EdgeInsets.all(16),
            decoration: BoxDecoration(
              color: Colors.black,
