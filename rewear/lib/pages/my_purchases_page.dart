...
class _MyPurchasesPageState extends State<MyPurchasesPage> {
  ...
  Future<void> _editAddress(Map<String, dynamic> order) async {
    ...
    final addressCtrl =
        TextEditingController(text: order['buyer_address'] ?? '');
    final phoneCtrl =
        TextEditingController(text: order['buyer_phone'] ?? '');
    ...
    final saved = await showDialog<bool>(
      ...
      builder: (_) => AlertDialog(
        ...
        title: const Text('Edit Shipping Info',
            style: TextStyle(
        ...
        content: Column(
          ...
          children: [
            ...
            TextField(
              ...
              maxLines: 3,
              decoration:
                  _inputDec('Shipping Address', Icons.location_on_outlined),
            ),
          ],
        ),
        actions: [
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(children: [
                    ...
                    _statBox(
                        '$active', 'Delivering', const Color(0xFF2563EB)),
                    const SizedBox(width: 10),
                    _statBox(
  ...
  Widget _orderCard(Map<String, dynamic> o) {
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        if (isCompleted) ...[
          const SizedBox(height: 10),
          _banner(Icons.check_circle_outline_rounded,
              const Color(0xFF16A34A), const Color(0xFFEAFAF0),
              'You confirmed receipt — order complete!'),
        ],
        if (isCancelled) ...[
          const SizedBox(height: 10),
          _banner(Icons.cancel_outlined, const Color(0xFFDC2626),
          ...
          if (isProcessing)
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: const Text('I Received My Item',
                    style: TextStyle(
                        fontSize: 14,
                        fontWeight: FontWeight.w700,
                        color: Colors.white)),
