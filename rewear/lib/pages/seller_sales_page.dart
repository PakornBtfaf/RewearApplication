...
class _SellerSalesPageState extends State<SellerSalesPage> {
  ...
  IconData _statusIcon(String s) {
    switch (s) {
      case 'On Delivery': return Icons.local_shipping_outlined;
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Row(children: [
          Container(
            ...
            child:
                (o['product_image_url'] as String?)?.isNotEmpty == true
                    ? Image.network(o['product_image_url'],
                        fit: BoxFit.cover,
              ...
              children: [
                ...
                Row(children: [
                  const Icon(Icons.person_outline_rounded,
                      size: 14, color: Color(0xFF9A9A9A)),
      ...
      child: AnimatedContainer(
        ...
        child: Text(label,
            style: TextStyle(
                ...
                fontWeight: FontWeight.w600,
                color:
                    sel ? Colors.white : const Color(0xFF666666))),
      ),
    );
  }
