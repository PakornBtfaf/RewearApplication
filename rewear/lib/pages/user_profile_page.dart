...
class _UserProfilePageState extends State<UserProfilePage> {
                ...
                SliverAppBar(
                  ...
                  title: Text(name,
                      style: const TextStyle(fontWeight: FontWeight.w800,
                          fontSize: 16, letterSpacing: -0.4, color: Colors.black)),
                  expandedHeight: 260,
  ...
  Widget _statCol(String value, String label) => Column(children: [
        ...
        Text(label, style: const TextStyle(fontSize: 11, color: Color(0xFF9A9A9A), fontWeight: FontWeight.w500)),
      ]);

  Widget _vDivider() => Container(height: 32, width: 1, color: const Color(0xFFF0F0F0));
}
...
class _ProductCard extends StatelessWidget {
  ...
  Widget _ph() => Container(
        color: const Color(0xFFF0F0F0),
        child: const Center(child: Icon(Icons.checkroom_outlined, size: 36, color: Color(0xFFCCCCCC))));
}