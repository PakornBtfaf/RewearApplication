...
class _MyShopPageState extends State<MyShopPage> {
          ...
          child: Center(
            child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
              Container(width: 56, height: 56,
                ...
                child: const Icon(Icons.lock_outline, size: 24, color: Color(0xFF888888))),
              const SizedBox(height: 16),
              const Text('Sign in to manage your shop',
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(icon: const Icon(Icons.refresh_rounded, size: 20), onPressed: _loadProducts),
        ],
      ),
      body: Column(
        children: [
                ...
                : _products.isEmpty
                    ? Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                        Container(width: 64, height: 64,
                          ...
                          child: const Icon(Icons.storefront_outlined, size: 28, color: Color(0xFFBBBBBB))),
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color: isActive ? Colors.black : const Color(0xFFEEEEEE),
  ...
  Widget _statItem(String value, String label) => Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(value, style: const TextStyle(fontSize: 22, fontWeight: FontWeight.w800, letterSpacing: -0.6)),
          Text(label, style: const TextStyle(fontSize: 11, color: Color(0xFF9A9A9A))),
        ],
      );

  Widget _thumb() => Container(
        color: const Color(0xFFF5F5F5),
        child: const Center(child: Icon(Icons.checkroom_outlined, size: 28, color: Color(0xFFCCCCCC))));
}